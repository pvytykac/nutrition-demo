...
Automated CI pipeline for the nutrition-demo project that builds, tests, and lints the backend and frontend modules on push and pull request events. TBD: detailed rationale.
